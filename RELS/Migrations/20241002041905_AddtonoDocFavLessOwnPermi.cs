...
{
    /// <inheritdoc />
    public partial class AddtonoDocFavLessOwnPermi : Migration
    {
        //// <inheritdoc />
        ...
        ");
            ...
            BEGIN
                ...
                IF EXISTS (SELECT * FROM inserted)
                BEGIN
                    INSERT INTO LessorHistories (IdLessor, Person, Modified, ModifiedBy)
                    SELECT i.Id, i.PersonId,
                        GETDATE(),
                           CASE 
                               WHEN EXISTS (SELECT * FROM deleted) THEN 'UPDATE' 
                               ELSE 'INSERT' 
                ...
                BEGIN
                    INSERT INTO LessorHistories (IdLessor, Person, Modified, ModifiedBy)
                    SELECT d.Id, d.PersonId, GETDATE(), 'DELETE'
                          FROM deleted d;
                END
            END;
        ");
            ...
            BEGIN
                ...
                IF EXISTS (SELECT * FROM inserted)
                BEGIN
                    INSERT INTO OwnerHistories (IdOwner, Person, Modified, ModifiedBy)
                    SELECT i.Id, i.PersonId,
                        GETDATE(),
                           CASE 
                               WHEN EXISTS (SELECT * FROM deleted) THEN 'UPDATE' 
